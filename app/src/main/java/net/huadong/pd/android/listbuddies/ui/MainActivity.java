package net.huadong.pd.android.listbuddies.ui;
...
import net.huadong.pd.android.listbuddies.Utils.SharePreferences;
import net.huadong.pd.android.listbuddies.provider.FragmentTags;
import net.huadong.pd.android.listbuddies.ui.fragments.CustomizeFragment;
import net.huadong.pd.android.listbuddies.ui.fragments.ListBuddiesFragment;
...
public class MainActivity extends ActionBarActivity implements CustomizeFragment.OnCustomizeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listbuddy_activity_main);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.listbuddy_main, menu);
