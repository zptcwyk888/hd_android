package net.huadong.pd.android.listbuddies.Utils;

import android.content.SharedPreferences;

import net.huadong.pd.android.listbuddies.ListBuddies;
import net.huadong.pd.android.listbuddies.provider.SharedPrefFiles;
